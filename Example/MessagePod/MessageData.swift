...
//        Message(text: "本项目并非 Google 官方项目, @而是由国 内程序员凭热情创建和维护"),
//        Message(text: "如果你关注的是 Google 官方英文版"),
//        Message(text: "每个较大的开源项目都有自己的风格指南: #关于 如何为该项目编写代码的一系列约定 (有时候会比较武断). 当所有代码均保持一致的风格, 在理解大型代码库时更为轻松"),
...
//        Message(text: "Google C++ 风格指南 http://www.baidu.com"),
